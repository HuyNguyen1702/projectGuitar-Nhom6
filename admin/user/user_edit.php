...
if(isset($_POST['sbm'])){
    $user_id = $_POST['user_id'];
     ...
     $sql = "UPDATE `tbl_user` SET `user_id`='$user_id',`user_name`='$user_name',`user_pass`='$user_pass',`user_phone`='$user_phone',`user_address`='$user_address',`user_email`='$user_email',`user_mode`='$user_mode' WHERE `user_id`='$user_id'";
    ...
    <div class="main">
        <div class="nav-small"  style="height: calc(100vh - 80px); width:192px;">
            <div class="nav-small_left">
                ...
                <div class="nav-item">
                    <a href="user_show.php">TÀI KHOẢN</a>
                </div>
                <div class="nav-item">
        ...
        <div class="display-data">
            ...
            <div class="add">
                <form action="" method="POST">
                    ...
                    <input type="text" id="fname" name="user_id" placeholder="Mã tài khoản" readonly require value="<?php echo $row['user_id']; ?>">

                    <label for="fname">Tên Tài Khoản</label>
                    <input type="text" id="fname" name="user_name" placeholder="Tên sản phẩm" required value="<?php echo $row['user_name']; ?>">
                    ...
                    <input type="text" id="lname" name="user_email" placeholder="Email" required value="<?php echo $row['user_email']; ?>"> 
